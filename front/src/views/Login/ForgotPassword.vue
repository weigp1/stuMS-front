...
import { sendVerificationCode, confirmVerificationCode } from '../../api/api.js'
...
async function SendVerificationCode() {
  ...
  let email = { 'toEmail': input_email.value }
  try {
...
async function ResetPassword() {
  ...
  try {
    let resetinfo = { 'toEmail': input_email.value, 'userCode': input_verification_code.value }
    let response = await confirmVerificationCode(resetinfo)
