    ...
    render() {
        ...
        return ((0, vue_1.h)(Component, { class: [
            ...
            (0, _utils_1.resolveWrappedSlot)($slots.header, (children) => {
                return children || this.title || this.closable ? ((0, vue_1.h)("div", { class: [`${mergedClsPrefix}-card-header`, this.headerClass], style: this.headerStyle },
            ...
            (0, _utils_1.resolveWrappedSlot)($slots.default, (children) => children && ((0, vue_1.h)("div", { class: [`${mergedClsPrefix}-card__content`, this.contentClass], style: this.contentStyle, role: "none" }, children))),
            (0, _utils_1.resolveWrappedSlot)($slots.footer, (children) => children && [
                (0, vue_1.h)("div", { class: [`${mergedClsPrefix}-card__footer`, this.footerClass], style: this.footerStyle, role: "none" }, children)
            ]),
