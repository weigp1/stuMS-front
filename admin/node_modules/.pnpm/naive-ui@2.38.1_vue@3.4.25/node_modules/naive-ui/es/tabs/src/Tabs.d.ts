...
declare const _default: import("vue").DefineComponent<{
    ...
    handleNavResize: import("lodash-es").DebouncedFunc<(entry: ResizeObserverEntry) => void>;
    mergedSize: import("vue").ComputedRef<"small" | "medium" | "large">;
    handleScroll: import("lodash-es").DebouncedFunc<(e: Event) => void>;
    handleTabsResize: import("lodash-es").DebouncedFunc<(entry: ResizeObserverEntry) => void>;
