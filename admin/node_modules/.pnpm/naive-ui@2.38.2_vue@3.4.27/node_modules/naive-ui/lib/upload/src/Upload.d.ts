...
import type { FuncOrRecordOrUndef, OnUpdateFileList, OnBeforeUpload, ListType, OnPreview, CreateThumbnailUrl, CustomRequest, OnError, ShouldUseThumbnailUrl, RenderIcon } from './interface';
...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly shouldUseThumbnailUrl: {
        readonly type: PropType<ShouldUseThumbnailUrl>;
        readonly default: (file: Required<UploadFileInfo>) => boolean;
    };
    readonly createThumbnailUrl: PropType<CreateThumbnailUrl>;
    readonly abstract: BooleanConstructor;
    readonly max: NumberConstructor;
