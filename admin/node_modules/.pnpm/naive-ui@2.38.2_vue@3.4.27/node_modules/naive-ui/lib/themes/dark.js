...
const styles_80 = require("../typography/styles");
const styles_81 = require("../tree/styles");
...
exports.darkTheme = {
    ...
    GradientText: styles_35.gradientTextDark,
    Icon: styles_36.iconDark,
    ...
    List: styles_43.listDark,
    LoadingBar: styles_44.loadingBarDark,
    Log: styles_45.logDark,
    Menu: styles_46.menuDark,
    Mention: styles_47.mentionDark,
    Message: styles_48.messageDark,
    Modal: styles_49.modalDark,
    Notification: styles_50.notificationDark,
    PageHeader: styles_51.pageHeaderDark,
    Pagination: styles_52.paginationDark,
    Popconfirm: styles_53.popconfirmDark,
    Popover: styles_54.popoverDark,
    Popselect: styles_55.popselectDark,
    Progress: styles_56.progressDark,
    QrCode: styles_57.qrcodeDark,
    Radio: styles_58.radioDark,
    Rate: styles_59.rateDark,
    Result: styles_60.resultDark,
    Row: styles_61.rowDark,
    Scrollbar: styles_62.scrollbarDark,
    Select: styles_63.selectDark,
    Skeleton: styles_64.skeletonDark,
    Slider: styles_65.sliderDark,
    Space: styles_66.spaceDark,
    Spin: styles_67.spinDark,
    Statistic: styles_68.statisticDark,
    Steps: styles_69.stepsDark,
    Switch: styles_70.switchDark,
    Table: styles_71.tableDark,
    Tabs: styles_72.tabsDark,
    Tag: styles_73.tagDark,
    Thing: styles_74.thingDark,
    TimePicker: styles_75.timePickerDark,
    Timeline: styles_76.timelineDark,
    Tooltip: styles_77.tooltipDark,
    Transfer: styles_78.transferDark,
    Tree: styles_81.treeDark,
    TreeSelect: styles_79.treeSelectDark,
    Typography: styles_80.typographyDark,
    Upload: styles_82.uploadDark,
    Watermark: styles_83.watermarkDark,
    Split: styles_84.splitDark,
    FloatButton: styles_34.floatButtonDark,
    FloatButtonGroup: styles_86.floatButtonGroupDark
};
