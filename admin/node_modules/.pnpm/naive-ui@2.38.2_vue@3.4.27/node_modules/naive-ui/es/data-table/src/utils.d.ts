...
import type { SortOrder, TableBaseColumn, InternalRowData, SortOrderFlag, SortState, CreateRowClassName, TableSelectionColumn, TableColumn, TableExpandColumn, RowData } from './interface';
...
export declare function generateCsv(columns: TableColumn[], data: RowData[]): string;
