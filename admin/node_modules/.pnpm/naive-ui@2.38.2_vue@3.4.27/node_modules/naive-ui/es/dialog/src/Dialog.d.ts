...
export declare const NDialog: import("vue").DefineComponent<{
    ...
    titleClass: import("vue").PropType<string | (string | undefined)[]>;
    titleStyle: import("vue").PropType<string | CSSProperties>;
    contentClass: import("vue").PropType<string | (string | undefined)[]>;
    contentStyle: import("vue").PropType<string | CSSProperties>;
    actionClass: import("vue").PropType<string | (string | undefined)[]>;
