...
export declare const dropdownProps: {
    ...
    readonly nodeProps: PropType<import("./interface").NodeProps>;
    readonly labelField: {
...
declare const _default: import("vue").DefineComponent<{
    ...
    tmNodes: import("vue").ComputedRef<TreeNode<import("./interface").DropdownOption | import("../../menu/src/interface").MenuRenderOption, import("./interface").DropdownGroupOption, import("./interface").DropdownIgnoredOption>[]>;
