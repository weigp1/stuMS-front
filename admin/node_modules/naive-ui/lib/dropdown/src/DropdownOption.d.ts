...
declare const _default: import("vue").DefineComponent<{
    ...
    tmNode: {
        type: PropType<TreeNode<import("./interface").DropdownOption, MenuGroupOption, import("./interface").DropdownIgnoredOption>>;
        required: true;
    };
    parentKey: {
    ...
    rawNode: import("vue").ComputedRef<import("./interface").DropdownOption | MenuGroupOption | import("./interface").DropdownIgnoredOption>;
