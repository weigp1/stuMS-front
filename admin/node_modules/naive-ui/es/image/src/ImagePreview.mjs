...
import { RotateClockwiseIcon, RotateCounterclockwiseIcon, ZoomInIcon, ZoomOutIcon, ResizeSmallIcon } from "../../_internal/icons/index.mjs";
...
import { prevIcon, nextIcon, closeIcon, downloadIcon } from "./icons.mjs";
