...
hoistedDependencies:
  ...
  '@css-render/vue3-ssr@0.15.12(vue@3.4.25)':
  ...
  treemate@0.3.11:
    treemate: private
  vdirs@0.1.8(vue@3.4.25):
    vdirs: private
  vooks@0.2.12(vue@3.4.25):
    vooks: private
  vue-demi@0.14.7(vue@3.4.25):
    vue-demi: private
  vueuc@0.4.58(vue@3.4.25):
    vueuc: private
included:
  dependencies: true
...
pendingBuilds: []
prunedAt: Fri, 31 May 2024 06:39:23 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: D:\Web\stuMS-front\admin\node_modules\.pnpm
